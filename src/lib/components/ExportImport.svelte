...
<div class="space-y-2">
  ...
  <button
    ...
    disabled={isImporting || isOfflineAuthenticated}
    title={isOfflineAuthenticated ? "You're offline — import unavailable" : undefined}
  ...
  >
    {isImporting ? 'Importing...' : isOfflineAuthenticated ? 'Import (offline)' : 'Import'}
  </button>
</div>
